...
def attack(char_name: str, char_class: str) -> str:
    """Определение нанесённого противнику урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определение блокированного урона от противника."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не блокировал урон противнику')


def special(char_name: str, char_class: str) -> str:
    """Определение результатов применённых умений."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Печать описания героя, выбор проведения атак."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    ...
    print(char_class, type(char_class))
